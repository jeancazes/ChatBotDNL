...
"If you get vaccinated, you will protect not only yourself but also vulnerable people around you."`,
    ...
    ttsOptions: { rate: 0.85, pitch: 1.15, gender: 'female', openaiVoice: 'nova',  kokoroVoice: 'af_sarah' },
    scoringCriteria: {
...
"If we don't reduce emissions, sea levels will rise by 1 metre by 2100."`,
    ...
    ttsOptions: { rate: 1.0, pitch: 0.9, gender: 'male', openaiVoice: 'onyx',  kokoroVoice: 'bm_george' },
    scoringCriteria: {
...
"GMOs are regulated by international agencies."`,
    ...
    ttsOptions: { rate: 0.9, pitch: 0.85, gender: 'male', openaiVoice: 'echo',  kokoroVoice: 'bm_lewis' },
    scoringCriteria: {
...
"Plant-based proteins are just as nutritious as animal proteins."`,
    ...
    ttsOptions: { rate: 1.05, pitch: 0.95, gender: 'male', openaiVoice: 'fable', kokoroVoice: 'am_michael' },
    scoringCriteria: {
